          ...
          >
            <div className="td-header">
              <div className="td-title">
                <h1>
                  {getServiceType(selectedTicket) === "Return"
                    ? "Return Request"
                    : "Repair Request"}
                </h1>
                ...
                normalizeStatus(selectedTicket.status) !== "Closed" && (
                  <div className="td-timeline">
                    {(() => {
                      ...
                      const isDropoff =
                        selectedTicket.deliveryMethod === "dropoff" ||
              ...
              <div className="td-grid">
                ...
                <div className="td-main">
                  ...
                  <div className="td-section">
                    ...
                    <div className="td-text">
                      ...
                      <strong>Name:</strong>{" "}
                      {selectedTicket.contactInfo?.fullName ||
                        selectedTicket.contactName ||
                        selectedTicket.fullName ||
                        "N/A"}{" "}
                      <br />
                      <strong>Email:</strong>{" "}
                      {selectedTicket.contactInfo?.email ||
                        selectedTicket.contactEmail ||
                        selectedTicket.email ||
                        "N/A"}{" "}
                      <br />
                      <strong>Phone:</strong>{" "}
                      {selectedTicket.contactInfo?.phone ||
                  ...
                  <div className="td-section">
                    ...
                    <div className="td-text">
                      {(() => {
                        const address =
                          selectedTicket.contactInfo?.address ||
                          selectedTicket.address ||
                          "-";
                        const city =
                          selectedTicket.contactInfo?.city ||
                          selectedTicket.city ||
                          "-";
                        const postalCode =
                          selectedTicket.contactInfo?.postalCode ||
                          selectedTicket.postalCode ||
                          selectedTicket.zipCode ||
                          "-";
                        const deliveryMethod =
                          selectedTicket.deliveryMethod || "courier";
                        const isDropoff =
                          deliveryMethod === "dropoff" ||
                          address === "Store Drop-off" ||
                          city === "-";
                ...
                <div className="td-sidebar">
                  ...
                  <div className="td-section">
                    ...
                    {selectedTicket.issue?.attachments &&
                    selectedTicket.issue.attachments.length > 0 ? (
                      <div>
                        <div
                          style={{
                            fontSize: "0.85rem",
                        ...
                        >
                          Photos ({selectedTicket.issue.attachments.length})
                        </div>
                        <div className="td-attachments-grid">
                          {selectedTicket.issue.attachments.map(
                            (file, index) => {
              ...
              <div className="modal-overlay" style={{ zIndex: 1100 }}>
                <div className="modal-box" style={{ maxWidth: "400px" }}>
                  <div className="rating-modal-content">
                    ...
                    <h2 className="td-title" style={{ fontSize: "20px" }}>
      ...
      {lightboxOpen && (
        <div
          ...
          style={{
            ...
            zIndex: 9999, // Πολύ υψηλό για να βγει πάνω από όλα
            display: "flex",
            alignItems: "center",
